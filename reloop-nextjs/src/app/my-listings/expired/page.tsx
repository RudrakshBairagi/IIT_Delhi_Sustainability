    ...
    if (completed) {
        return (
            <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
                <div className="w-28 h-28 bg-green-500 rounded-full border border-outline-variant/10 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex items-center justify-center mb-6 animate-bounce">
                    <span className="material-symbols-outlined text-white text-6xl" style={{ fontVariationSettings: "'FILL' 1" }}>eco</span>
                </div>
                <h1 className="text-2xl font-extrabold text-dark dark:text-white mb-2">Great Choice!</h1>
                <p className="text-dark/70 dark:text-white/70 mb-6 text-sm max-w-xs">
                    You&apos;ve helped the planet and earned rewards
                </p>
                <div className="bg-surface-container-low rounded-2xl border border-outline-variant/10 shadow-sm p-6 mb-6 w-full max-w-xs">
                    <p className="text-4xl font-extrabold text-dark mb-2">+{coinsEarned}</p>
                    <p className="text-sm font-bold text-dark/70">🪙 Eco Coins Earned</p>
                </div>
                <button
                    onClick={() => router.push('/my-listings')}
                    className="w-full max-w-xs bg-dark text-white font-extrabold py-4 rounded-2xl border border-outline-variant/10 shadow-[0_2px_10px_rgba(0,0,0,0.02)]"
                >
                    View My Listings
                </button>
            </div>
            ...
            <div className="min-h-screen bg-background">
                ...
                <div className="px-5 pb-28 pt-4 space-y-4">
                    ...
                    <motion.div
                        ...
                        className="bg-white dark:bg-dark-surface rounded-2xl border border-outline-variant/10 dark:border-gray-600 shadow-[0_2px_10px_rgba(0,0,0,0.02)] p-4"
                    >
                        <div className="flex gap-3">
                            <div
                                className="w-20 h-20 rounded-xl border border-outline-variant/10 bg-gray-100 shrink-0 bg-cover bg-center"
                    ...
                    <motion.div
                        ...
                        className="bg-card-blue rounded-xl border border-outline-variant/10 shadow-sm px-4 py-3"
                    >
                    ...
                    <div className="grid grid-cols-1 gap-4 mt-6">
                        ...
                        <motion.button
                            ...
                            disabled={processing}
                            className="group bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl border border-outline-variant/10 shadow-[0_2px_10px_rgba(0,0,0,0.02)] p-6 text-left hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <div>
                                            <p className="text-xl font-extrabold text-dark uppercase">Recycle It</p>
                                ...
                                <div className="bg-white/40 backdrop-blur-sm rounded-xl px-3 py-2 border border-dark/10 shrink-0 ml-3">
                                    <p className="text-2xl font-extrabold text-dark">+{recycleCoins}</p>
                        ...
                        <motion.button
                            ...
                            disabled={processing}
                            className="group bg-gradient-to-br from-pink-400 to-rose-500 rounded-2xl border border-outline-variant/10 shadow-[0_2px_10px_rgba(0,0,0,0.02)] p-6 text-left hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                            <div className="flex items-start justify-between">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <div>
                                            <p className="text-xl font-extrabold text-dark uppercase">Donate It</p>
                                    ...
                                    <div className="inline-flex items-center gap-1 bg-white/30 rounded-lg px-2 py-1 mt-2">
                                        ...
                                        <span className="text-[10px] font-extrabold text-dark">+10 BONUS COINS</span>
                                    </div>
                                </div>
                                <div className="bg-white/40 backdrop-blur-sm rounded-xl px-3 py-2 border border-dark/10 shrink-0 ml-3">
                                    <p className="text-2xl font-extrabold text-dark">+{donateCoins}</p>
                                    <p className="text-[10px] font-bold text-dark/70">COINS</p>
                                </div>
                            </div>
                        </motion.button>
        ...
        <div className="min-h-screen bg-background">
            ...
            >
                {isLoading ? (
                    ...
                    expiredListings.map((listing) => (
                        <motion.div
                            ...
                            className="bg-white dark:bg-dark-surface rounded-xl border border-outline-variant/10 dark:border-gray-600 shadow-sm p-4 cursor-pointer hover:scale-[1.01] active:scale-[0.99] transition-all"
                        >
                            <div className="flex gap-3">
                                <div
                                    className="w-16 h-16 rounded-lg border border-outline-variant/10 bg-gray-100 shrink-0 bg-cover bg-center"
                ...
                {!isLoading && expiredListings.length === 0 && (
                    <motion.div variants={itemVariants} className="bg-surface-container-low rounded-xl border border-outline-variant/10 shadow-sm px-4 py-3">
